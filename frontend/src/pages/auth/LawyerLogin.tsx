...
export default function LawyerLogin() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-teal/10 rounded-full blur-3xl" />
      ...
      <Card className="relative w-full max-w-md glass-card">
        <CardHeader className="text-center">
          ...
          <CardTitle className="font-heading text-2xl">Lawyer Login</CardTitle>
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link to="/auth/lawyer/signup" className="text-teal hover:text-teal-light font-medium">
              Register as Lawyer
            </Link>
          </div>
